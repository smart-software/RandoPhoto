...
public class UserManager implements IUserManager{
	...
	public ILoggedUser GetCurrentLoggedUser() {
		...
		ILoggedUser loggedUser = (ILoggedUser) new User(); // моих знаний не хватает. Ќаверное здесь лучше ILoggedUser loggedUser = new ILoggedUser(); но так Eclipse не позвол€ет сделать 
